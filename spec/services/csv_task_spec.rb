...
describe 'csv split' do
  ...
  it 'splits file in smaller parts' do
    ...
    expect(CSV.read(folder.join("customer_data1.csv"))).to include ["149", "Chickie", "Grayce", "Chickie.Grayce@blamail.com", "545"]
    expect(CSV.read(folder.join("customer_data2.csv"))).to include ["150", "Evita", "Douglass" , "Evita.Douglass@blamail.com", "742"]
